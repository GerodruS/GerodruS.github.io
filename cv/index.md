...
|:-------------|:------------------|:------|:------|
| **Empty Stage**<br/>Freelance<br/>_Sep 2016 - Present_ | **Make it Less**<br/>[Twitter](https://twitter.com/make_it_less), [iOS](https://appstore.com/makeitless), [Android](https://play.google.com/store/apps/details?id=com.eulerbrain.makeitless)<br/>_in development for iOS/Android_ | - game logic;<br/>- optimizations;<br/>- services integration;<br/>- UI development. | Unity3D, C# |
| **Rising Wave**<br/>Remote, part-time<br/>_Feb 2016 - Present_ | **SMASH BASH: Date with the Desert**<br/>[Site](http://smash-bash.com/)<br/>_in development for PC/iOS/Android_ | - architecture design;<br/>- game logic;<br/>- UI development;<br/>- internal utilities. | Defold, Lua |
